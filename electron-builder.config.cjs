...
const config = {
    ...
    mac: {
        ...
        extendInfo: {
            NSContactsUsageDescription: "A CLI application running in SafTerm wants to use your contacts.",
            NSRemindersUsageDescription: "A CLI application running in SafTerm wants to use your reminders.",
            NSLocationWhenInUseUsageDescription:
                "A CLI application running in SafTerm wants to use your location information while active.",
            NSLocationAlwaysUsageDescription:
                "A CLI application running in SafTerm wants to use your location information, even in the background.",
            NSCameraUsageDescription: "A CLI application running in SafTerm wants to use the camera.",
            NSMicrophoneUsageDescription: "A CLI application running in SafTerm wants to use your microphone.",
            NSCalendarsUsageDescription: "A CLI application running in SafTerm wants to use Calendar data.",
            NSLocationUsageDescription: "A CLI application running in SafTerm wants to use your location information.",
            NSAppleEventsUsageDescription: "A CLI application running in SafTerm wants to use AppleScript.",
        },
    },
    linux: {
    ...
    win: {
        ...
        signtoolOptions: windowsShouldSign && {
            ...
            publisherName: "Irfan Saf",
            certificateSubjectName: "Irfan Saf",
    ...
    publish: {
        provider: "generic",
        url: "https://github.com/irfansaf/safterm/releases",
    },
    afterPack: (context) => {
