...
declare global {
    ...
    type ElectronApi = {
        ...
        setWindowInitStatus: (status: "ready" | "saf-ready") => void; // set-window-init-status
        ...
        showOpenDialog: (opts?: { title?: string; defaultPath?: string }) => Promise<string | null>; // show-open-dialog
    };
