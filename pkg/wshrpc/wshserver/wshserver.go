...
import (
	...
	"github.com/irfansaf/safterm/pkg/baseds"
	"github.com/irfansaf/safterm/pkg/blockcontroller"
	"github.com/irfansaf/safterm/pkg/blocklogger"
	"github.com/irfansaf/safterm/pkg/buildercontroller"
	"github.com/irfansaf/safterm/pkg/filebackup"
	"github.com/irfansaf/safterm/pkg/filestore"
	"github.com/irfansaf/safterm/pkg/genconn"
	"github.com/irfansaf/safterm/pkg/jobcontroller"
	"github.com/irfansaf/safterm/pkg/panichandler"
	"github.com/irfansaf/safterm/pkg/remote"
	"github.com/irfansaf/safterm/pkg/remote/conncontroller"
	"github.com/irfansaf/safterm/pkg/remote/fileshare/wshfs"
	"github.com/irfansaf/safterm/pkg/secretstore"
	"github.com/irfansaf/safterm/pkg/suggestion"
	"github.com/irfansaf/safterm/pkg/telemetry"
	"github.com/irfansaf/safterm/pkg/telemetry/telemetrydata"
	"github.com/irfansaf/safterm/pkg/util/envutil"
	"github.com/irfansaf/safterm/pkg/util/shellutil"
	"github.com/irfansaf/safterm/pkg/util/utilfn"
	"github.com/irfansaf/safterm/pkg/waveappstore"
	"github.com/irfansaf/safterm/pkg/waveapputil"
	"github.com/irfansaf/safterm/pkg/wavebase"
	"github.com/irfansaf/safterm/pkg/wavejwt"
	"github.com/irfansaf/safterm/pkg/waveobj"
	"github.com/irfansaf/safterm/pkg/wcloud"
...
func (ws *WshServer) WriteTempFileCommand(ctx context.Context, data wshrpc.CommandWriteTempFileData) (string, error) {
	...
	tempDir, err := os.MkdirTemp("", "safterm-")
	if err != nil {
